...
public class ArmLiftCANTalon extends TalonSRX {
	...
	private int m_tolerance = 0; 		// Lift encoder range * 0.05
	...
	public ArmLiftCANTalon(String name, int deviceID, int slotNum) {
		...
		setNeutralMode(NeutralMode.Brake);
 		...
 		// Set Grayhill encoder as feedback device
