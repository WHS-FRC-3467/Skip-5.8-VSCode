...
/**
 *  Starting in the middle position, drive to left side of Switch and drop in Cube
 */

public class AutoLeftSwitch_Middle extends CommandGroup {

    public  AutoLeftSwitch_Middle() {
